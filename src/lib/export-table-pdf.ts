...
@font-face{font-family:Thmanyah;src:url("${FONT_URL}") format("opentype");font-weight:900}@page{size:A4 portrait;margin:12mm}*{box-sizing:border-box;-webkit-print-color-adjust:exact;print-color-adjust:exact}body{margin:0;font-family:Thmanyah,Tahoma,sans-serif;color:#35312b}.sheet{min-height:273mm;border:2.2mm solid #357d63;outline:.9mm solid #c9a24b;outline-offset:1.6mm;padding:14mm 12mm 12mm;text-align:center;display:flex;flex-direction:column;align-items:center;background:#fffdf6}.orn{font-size:22pt;color:#c9a24b}.bismillah{margin-top:3mm;font-size:13pt;color:#756e64}.org{margin-top:6mm;font-size:10pt;color:#756e64}h1{margin:3mm 0 0;font-size:30pt;color:#357d63}.grant{margin-top:12mm;font-size:12pt;color:#756e64}.name{margin-top:4mm;font-size:26pt;border-bottom:1px solid #c9a24b;padding:0 10mm 2mm}.photo{width:42mm;height:42mm;border-radius:50%;object-fit:cover;border:1.6mm solid #c9a24b;margin-top:9mm}.photo.fallback{display:grid;place-items:center;font-size:30pt;color:#756e64;border-color:#e6f3e8;background:#f2dfad}.body{margin-top:9mm;max-width:150mm;font-size:12.5pt;line-height:2}.chip{margin-top:7mm;border:1px solid #357d63;border-radius:999px;background:#e6f3e8;padding:2.5mm 8mm;font-size:12pt}.footer{margin-top:auto;width:100%;display:flex;align-items:flex-end;justify-content:space-between;padding-top:12mm}.sig{font-size:10.5pt;color:#756e64}.sig strong{display:block;margin-top:12mm;border-top:1px solid #ddd5c5;padding-top:2mm;font-size:11pt;color:#35312b}.date{font-size:10.5pt;color:#756e64}
</style></head><body><main class="sheet"><div class="orn">﴿ ﴾</div><p class="bismillah">بسم الله الرحمن الرحيم</p><p class="org">${escapeHtml(title)} — ${escapeHtml(sheet)}</p><h1>شهادة تقدير</h1><p class="grant">تُمنح هذه الشهادة بكل فخر إلى</p><div class="name">${escapeHtml(name)}</div>${embeddedPhoto ? `<img class="photo" src="${embeddedPhoto}" alt="">` : `<div class="photo fallback">${escapeHtml(name.charAt(0))}</div>`}<p class="body">وذلك تقديراً لاجتهاده في متابعة الحفظ والمراجعة وسعيه في طلب القرآن الكريم، سائلين الله أن يجعله من أهل القرآن وخاصّته.</p>${total ? `<div class="chip">المجموع: ${escapeHtml(total)}</div>` : ""}<div class="footer"><div class="sig">التوقيع<strong>معلم الحلقة</strong></div><div class="date">${escapeHtml(date)}</div><div class="sig">التوقيع<strong>إدارة المركز</strong></div></div></main></body></html>`);
}
